...
\begin{figure}[tb]
	\begin{center}
		\begin{tabular}{c}
			...
			\begin{minipage}{0.4\hsize}
				\begin{center}
					\scalebox{0.3}{\includegraphics{./img/eps/4-3-1.eps}}
					\hspace{1.6cm} [1]正方向の通信
				\end{center}
			\end{minipage}
			...
			\begin{minipage}{0.4\hsize}
				\begin{center}
					\scalebox{0.3}{\includegraphics{./img/eps/4-3-2.eps}}
					\hspace{1.6cm} [2]逆方向の通信
				\end{center}
			\end{minipage}
...
\begin{figure}[tb]
	\begin{center}
		\begin{tabular}{c}
			...
			\begin{minipage}{0.4\hsize}
				\begin{center}
					\scalebox{0.3}{\includegraphics{./img/eps/4-6-1.eps}}
					\hspace{1.6cm} [1]正方向の通信
				\end{center}
			\end{minipage}
			...
			\begin{minipage}{0.4\hsize}
				\begin{center}
					\scalebox{0.3}{\includegraphics{./img/eps/4-6-2.eps}}
					\hspace{1.6cm} [2]逆方向の通信
				\end{center}
			\end{minipage}
