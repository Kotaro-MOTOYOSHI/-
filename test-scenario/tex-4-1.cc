...
NS_LOG_INFO("128:");
	...
	// Create an On-Off application to send TCP datagrams from n6 to n1.
	...
	ns3::ApplicationContainer app = onoff.Install (terminals.Get (6));
	...
	app = onoff2.Install (terminals.Get (1));

	// Start the application
	app.Start (ns3::Seconds (6.0));
	app.Stop (ns3::Seconds (10.0));

	// Create ana optional packet sink to receive these packets
	app = sink.Install (terminals.Get (6));
	app.Start (ns3::Seconds (0.0));
